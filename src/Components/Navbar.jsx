...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 z-50 dark:bg-slate-900 dark:text-white ${sticky ? "sticky-navbar shadow-md bg-base-100 duration-300 transition-all ease-in-out" : ""}`}>
        <div className="navbar ">
          <div className="navbar-start ">
            <div className="dropdown">
              ...
              <a className="font-bold cursor-pointer md:text-2xl text-xl">BookBliss</a>
              <ul
                tabIndex={0}
          ...
          <div className="navbar-end pr-3 dark:bg-slate-900 dark:text-white">
            ...
            <div className="dark-mode md:px-6 px-3">
